...
namespace Sprite.UidGenerator.Providers.Snowflake
{
    ...
    {
        /// <summary>
        /// 默认使用经过优化过后支持高并发高效率和漂移算法配置
        /// </summary>
        public static SnowflakeGeneratorOptions Default => new SnowflakeGeneratorOptions()
        {
            SeqBitLength = 10,
            TopOverCostCount = 10000,
            Type = SnowflakeType.Drift
        };

        /// <summary>
        /// 雪花算法的类型，传统方法或者漂移方法
        /// </summary>
        public virtual SnowflakeType Type { get; set; }
        ...
        public SnowflakeGeneratorOptions(ushort workerId)
        {
            WorkerId = workerId;
        }
    }
